...
<body>
  ...
  <%-- 1~5출력 --%>
  <c:forEach var="num1" begin="1" end="5" step="1">  <%-- 감소는 안된다. --%>
    <div>${num1}</div>
  </c:forEach>
 ...
 <%-- 임의의 BlogPost3개를 List에 저장하고 화면에 출력하기 --%> 
  <%
    List<BlogPost> list = Arrays.asList(
        new BlogPost(1, "강아지", 100, LocalDate.of(2023, 1, 1)), 
        new BlogPost(2, "고양이", 150, LocalDate.of(2023, 1, 2)), 
        new BlogPost(3, "카피바라", 70, LocalDate.of(2023, 1, 3)) 
        );
